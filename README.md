This file is the baseline code for Kaggle - Medical Data Mining - Single Cell Change Prediction Competition

以上文件是Kaggle - Medical Data Mining - Single Cell Change Prediction Competition（单细胞变化预测）比赛的baseline代码
